...
<label for="company" class=" form-control-label">Course Pic</label> &nbsp;<img src="images/course/<?php echo $row->Picture;?>" width="100" height="100" value="<?php  echo $row->Picture;?>">

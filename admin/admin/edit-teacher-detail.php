                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">Update Staff</a></li>
...
<div class="form-group">
<label for="company" class=" form-control-label">Staff Pic</label> &nbsp;<img src="images/<?php echo $row->Picture;?>" width="100" height="100" value="<?php  echo $row->Picture;?>">
...
<div class="col-12">
<div class="form-group">
<label for="city" class=" form-control-label">Staff Qualifications(Sepereted by comma)</label>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Staff Mobile Number</label><input type="text" name="mobilenumber" id="mobilenumber" value="<?php  echo $row->MobileNumber;?>" class="form-control" required="true" maxlength="10" pattern="[0-9]+"></div>
</div>
</div>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Staff Address</label><textarea type="text" name="address" id="address" class="form-control" rows="5" cols="12" required="true"><?php  echo $row->Address;?></textarea></div>
</div>
<div class="col-12">
